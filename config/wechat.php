...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx53cbfe2e2f09b2b5'),         // AppID
    'secret'  => env('WECHAT_SECRET', '428fa20433ea86fe84572f529dbb2163'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'SilentGod'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'WlUPAeGYnQGbM2WV2uzFzUaTeUliS4cTQJ0HoxwGKDp'),                    // EncodingAESKey
