...
<body class="fixed-sidebar full-height-layout gray-bg">
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="footer">
                <div class="pull-right">&copy; 2014-2019 <a href="#" target="_blank">芜湖小洲蔬菜</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
