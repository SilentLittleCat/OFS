		...
		<div class="col-sm-12">
			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<form class="form-horizontal" role="form" id="coupon-form" action="{{ U('Backend/Coupon/store') }}" method="POST">
						{{ csrf_field() }}
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select class="form-control" name="type">
									<option value="1" selected>通用范围</option>
									<option value="2">男士餐</option>
									<option value="3">女士餐</option>
									<option value="4">工作餐</option>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="number" name="condition" class="form-control" required>
							</div>
						</div>
						<div class="form-group">
...
$(function() {
	...
	$('#coupon-form').on('click', '.btn-save', function() {
		$('#coupon-form').submit();
	});
