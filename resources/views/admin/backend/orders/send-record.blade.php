		...
		<div class="col-sm-12">
			...
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>配送记录&nbsp;&nbsp;订单号：{{ sprintf("%013d", $order->id) }}&nbsp;&nbsp;下单人：{{ $order->real_name }}&nbsp;&nbsp;手机：{{ $order->tel }}</h5>
				...
				<div class="ibox-content">
					<div class="row">
						<form class="form-horizontal" method="POST" action="{{ U('Backend/Order/sendRecord', ['id' => $user->id, 'order_id' => $order->id, 'search' => true]) }}">
							{{ csrf_field() }}
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable" id="order-send-table">
                        ...
                        <tbody>
                            @if(count($records) == 0)
                                <tr>
                                    <td colspan="5" class="sg-centered">暂无配送记录！</td>
                                </tr>
                            @else
