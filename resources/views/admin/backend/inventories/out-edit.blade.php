		...
		<div class="col-sm-12">
			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<div class="row">
						<form class="form-horizontal" role="form" method="POST" action="{{ U('Backend/Inventory/updateOut', ['id' => $inventory->id]) }}" id="edit-form">
							{{ csrf_field() }}
							...
							<div class="form-group">
								<label class="control-label col-sm-2 col-offset-2">出库量</label>
								<div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-2 col-offset-2">出库时间</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="time" id="enter_time" value="{{ $inventory->last_out_time }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-2 col-offset-2">出库人</label>
                                <div class="col-sm-6">
...
$(function() {
	...
	$('#operations').on('click', '.btn-cancel', function() {
		...
		url = "{{ U('Backend/Inventory/editOut', ['id' => $inventory->id]) }}";
		window.location = url;
